...
fun RoleSelectionScreen(navController: NavController) {
    Column(
        ...
        Text(
            text = "Chào mừng đến Foodle",
            fontSize = 28.sp,
            fontWeight = FontWeight.Bold,
            color = Primary
        )
        Text(
            text = "Bạn muốn tham gia với vai trò gì?",
            fontSize = 16.sp,
            color = Color.Gray,
        ...
        RoleCard(
            title = "Khách hàng",
            description = "Đặt món ăn yêu thích của bạn",
        ...
        RoleCard(
            title = "Tài xế",
            description = "Giao hàng và kiếm thêm thu nhập",
        ...
        RoleCard(
            title = "Chủ quán ăn",
            description = "Quản lý thực đơn và đơn hàng",
